...
typedef struct _HYPER_BSOD
{
    bool is_alloce_memory;
    PVOID buffer;
} HYPER_BSOD, * PHYPER_BSOD;


typedef struct _DEBUG_PORT
{
    bool port_is_detected;
    HANDLE debug_port;
} DEBUG_PORT, * PDEBUG_PORT;

typedef struct _THREAD_HIDE
{
    bool thread_is_hide;
    bool bad_hide_is_detected;
} THREAD_HIDE, * PTHREAD_HIDE;
